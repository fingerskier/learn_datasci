...
const host_name = process.argv[0] || require("os").host_name();
const host_port = process.argv[1] || "4437";

var client = new opcua.OPCUAClient();
var endpointUrl = `opc.tcp://${host_name}:${host_port}`
...
async.series([
    ...
    function(callback) {
       the_session.readVariableValue("ns=1;s=free_memory", function(err,dataValue) {
		   ...
		   console.log("Read Variable Value...")
           callback(err);
       });
    },
